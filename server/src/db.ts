...
db.exec(`
  ...
  CREATE INDEX IF NOT EXISTS idx_password_reset_tokens_user
    ON password_reset_tokens (user_id, id);
...
for (const ddl of [
  ...
  "ALTER TABLE map_objects ADD COLUMN reveal_object_id INTEGER REFERENCES map_objects(id) ON DELETE SET NULL",
  ...
  "ALTER TABLE tokens ADD COLUMN aura INTEGER",
  "ALTER TABLE tokens ADD COLUMN aura_max INTEGER",
  "ALTER TABLE tokens ADD COLUMN aura_color TEXT NOT NULL DEFAULT '#78e1ff'",
